...
function FaqSection() {
  return (
    <section
      id="faq"
      className="bg-slate-50 dark:bg-transparent container space-y-6 mx-auto p-5"
    >
      ...
      <div className="max-w-[550px] mx-auto text-center p-5 tracking-wide">
        <Accordion type="single" collapsible className="w-full leading-relaxed">
          <AccordionItem value="item-1 justify-start">
            <AccordionTrigger className="tracking-wider text-left font-normal text-base">
              1. O que é Terapia Integrativa?
            </AccordionTrigger>
            <AccordionContent className="leading-relaxed text-justify font-light ">
              <p>
